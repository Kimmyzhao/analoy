	...
	<div style="width: 100%; height: 50%;">
		<form action="api/equiment/addEqno" method="post">
			...
			<tr class="rowline">
				...
				<td><select style="height: 20px; width: 50%" id="type" name="type">
			...
			<tr class="rowline">
				...
				<td><input style="height: 20px; width: 50%" id="eqno" type="text" name="eqno" placeholder="请输入终端号(S/N):"></td>
			</tr>
			<tr class="rowline">
				<td colspan="2" style="text-align: center; width: 50%;">
					<input style="width: 20%; height: 30px;" type="submit" value="添加"></td>
			</tr>
			</table>
		</form>
	</div>
